...
ActiveRecord::Schema.define(version: 20130916184707) do
  ...
  add_index "categories", ["cat_name", "id"], name: "index_categories_on_cat_name_and_id", using: :btree
  ...
  add_index "posts", ["user_id", "id"], name: "index_posts_on_user_id_and_id", using: :btree
